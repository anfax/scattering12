...
c
      ...
      do 100 ir=1,10
        r=ir*0.5d0
        call seaton1(l,eryd,r,zion,f,fp,g,gp)
  ...
  100 continue
      ...
      do 200 ir=1,10
        r=ir*0.5d0
        call seaton1(l,epos,r,zion,f,fp,g,gp)
        wfgtst=f*gp-fp*g - 2.d0/pi
        write(6,*) r,g,wfgtst
  200 continue
      stop
...
c
      ...
      rr=r*zion
      eps=eryd/(zion**2)
      !call coulfg(l,eps,rr,acc,f0,f0p,g0,g0p,k,ierr,actacc,absf,absg)
...
C     XQ2 = AIMAG(ZDIGAM)
   12 continue
      return
      END
	subroutine seaton(l,eryd,r,zion,f,fp,g,gp,absf,absg)
	implicit real*8(a-h,o-z)
...
C
c      CALL COULFG(LL,EPSR,RO,ACC,FR0,FPR0,GR0,GPR0,KK
c     1,IERR,ACTACC)
C     PRINT *
C     PRINT *
