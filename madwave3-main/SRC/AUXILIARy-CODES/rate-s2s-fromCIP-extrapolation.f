!!!*************************************************************
! 文件/File: rate-s2s-fromCIP-extrapolation.f
...
!*************************************************************
      ...
      program rates_from_CIP_Extrapolation

      implicit none
!-------------------------------------------------------------------------------------
!     Calculates the inelastic state-2-state rate constant
!           from a Cumulative Inelastic probability
